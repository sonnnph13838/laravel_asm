...
<div class="login-box">
    <div class="login-logo">
        <a href="/" style="text-transform: uppercase;font-size: 30px;color:#fff;"><b>Register</b></a>
    </div>
    <!-- /.login-logo -->
...
{{--            <div class="form-group has-feedback">--}}
{{--                <input style="padding-left: 10px;" type="password" name="password2" class="form-control" placeholder="Repassword">--}}
{{--                <span class="glyphicon glyphicon-lock form-control-feedback"></span>--}}
{{--            </div>--}}
            <div class="row">
                {{--<div class="col-xs-8">--}}
                ...
                <!-- /.col -->
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-block btn-flat text-center btn-login">Register</button>
                </div>
