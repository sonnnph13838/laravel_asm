                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Tạo Mới Blog</h3>
                            </div>
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-6 offset-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title" value="@isset($request['title']){{ $request['title'] }}@endisset">
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-8">
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <input type="file" name="image1" accept="image/*" class="form-control-file @error('image1') is-invalid @enderror" id="cmt_truoc">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="content" class="form-control" id="content" value="@isset($request['content']){{ $request['content'] }}@endisset">
                                        </div>
                                        <br>
